...
assert_true(str_contains($index, 'Application created by Dr. Christopher B. Germann') && str_contains($index, '$appVersion = \'2.1.3\'') && str_contains($index, 'Version <?= h($appVersion) ?>') && str_contains($index, 'gmdate(\'Y\')') && str_contains($index, 'data-client-environment'), 'footer creator/version/year/client environment metadata missing');
